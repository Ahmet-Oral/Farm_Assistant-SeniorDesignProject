...
public class CropsDetailedEdit extends AppCompatActivity implements View.OnClickListener {
    ...
    public void init(){
        ...
        feature_et = findViewById(R.id.crops_detailed_edit_Features_pt);
        value_et = findViewById(R.id.crops_detailed_edit_Value_pt);
        ...
        delete_btn = findViewById(R.id.crops_detailed_edit_Delete_btn);
        cancel_btn = findViewById(R.id.crops_detailed_edit_Cancel_btn);
        save_btn = findViewById(R.id.crops_detailed_edit_Save_btn);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crops_detailed_edit);
        init();

        // These features key can't be edited because they are required in other activities
        if(feature_extra.equals("Acres") || feature_extra.equals("CropType") || feature_extra.equals("Name")){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.crops_detailed_edit_Delete_btn:
                // These features key can't be deleted because they are required in other activities
                if(feature_extra.equals("Acres") || feature_extra.equals("CropType") || feature_extra.equals("Name")){
                    Toast.makeText(CropsDetailedEdit.this, "Can't Delete This Feature", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            case R.id.crops_detailed_edit_Cancel_btn:
                Intent intent2 = new Intent(CropsDetailedEdit.this, CropsDetailed.class);
                intent2.putExtra("key",key_extra);
                startActivity(intent2);
                break;

            case R.id.crops_detailed_edit_Save_btn:
                // If feature or its value is null, give alert
                if (feature_et.getText().toString().equals("") || value_et.getText().toString().equals("")){
                    Toast.makeText(CropsDetailedEdit.this, "Feature or Value Cannot be Empty!" , Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Intent intent3 = new Intent(CropsDetailedEdit.this, CropsDetailed.class);
